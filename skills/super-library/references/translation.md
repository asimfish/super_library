...
1. Extract propositions before translating: entities, relations, logical
...
4. Check epistemic strength:
   ...
   - do not turn a non-significant trend into an improvement;
   - do not turn association into causation.
5. Back-check every number, seed count, dataset, symbol, inequality, citation,
   negative, and limiting phrase against the source text.

Prefer concise standard collocations. Avoid decorative synonyms introduced only
to sound academic.
