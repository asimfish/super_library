...
- [sample efficiency / data efficiency](https://raw.githubusercontent.com/asimfish/super_library/v0.4.0/dist/cards/reinforcement_learning/rl.term.sample-efficiency.001.md) — `rl.term.sample-efficiency.001` · term · sections=abstract,introduction,related_work,experiments,rebuttal,translation · tags=data efficiency,environment interactions
- [policy evaluation versus control](https://raw.githubusercontent.com/asimfish/super_library/v0.4.0/dist/cards/reinforcement_learning/rl.usage-note.policy-evaluation-control.001.md) — `rl.usage-note.policy-evaluation-control.001` · usage_note · sections=introduction,related_work,method,translation · tags=policy evaluation,control
