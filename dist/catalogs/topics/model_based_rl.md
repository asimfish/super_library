...
- [objective mismatch (model-based RL)](https://raw.githubusercontent.com/asimfish/super_library/v0.4.0/dist/cards/world_models/wm.definition.objective-mismatch.001.md) — definition · sections=introduction,related_work,method,limitations,translation · tags=objective mismatch,model-policy alignment
...
- [compounding model error](https://raw.githubusercontent.com/asimfish/super_library/v0.4.0/dist/cards/world_models/wm.term.compounding-model-error.001.md) — term · sections=introduction,related_work,experiments,limitations,translation · tags=error accumulation,long-horizon prediction
